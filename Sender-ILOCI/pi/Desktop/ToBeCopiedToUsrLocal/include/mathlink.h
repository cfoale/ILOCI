...
#define MLREVISION 25
#define MLMATHVERSION 10.0.0
...
#define MLTIBETANMASTIFF_CINT64         MLTK_64BIT_LITTLEENDIAN_STRUCTURE
...
#define MLTIBETANMASTIFF_MLINT64        MLTK_64BIT_LITTLEENDIAN_STRUCTURE
