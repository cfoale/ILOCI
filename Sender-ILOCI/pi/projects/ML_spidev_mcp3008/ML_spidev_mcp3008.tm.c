/*
 * This file automatically produced by /opt/Wolfram/WolframEngine/10.0/SystemFiles/Links/MathLink/DeveloperKit/Linux-ARM/CompilerAdditions/mprep from:
 *	ML_spidev_mcp3008.tm
...
void spidev_mcp3008 P(( int _tp1, int _tp2));
...
#endif
{
	int _res;
	_res = MLConnect(mlp);
	if (_res) _res = _definepattern(mlp, (char *)"SPIDevMcp3008[nx_Integer,dt_Integer]", (char *)"{ nx, dt }", 0);
